    ...
    function insertProduct(Request $request){
        ...
        if(is_null($check)){
                    ...
                    foreach ($check1 as $key ) {
                                ...
                                //set status in _finshed_product_status to 1 incase the product was over
                                DB::table('_finshed_product_status')->where('stock_id',$stockid)->where('product_id',$product_id)->update(['status'=>1]);
                                ...
                                if(is_null($id_stock_counter)){
                                    ...
                                    $stock_counter->save();
                                            ...
                                            //fetch number of product in the counter to update it
